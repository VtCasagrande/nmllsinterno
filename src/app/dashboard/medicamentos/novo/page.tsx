...
import { MedicamentoFormValues, LembreteMedicamentoFormValues, unidadesFrequencia } from '@/types/medicamentos';
import { criarLembreteMedicamento } from '@/lib/api/medicamentos';
...
export default function NovoLembreteMedicamento() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await criarLembreteMedicamento(formData);
      
      toast({
        title: "Lembrete criado com sucesso",
        description: "O lembrete de medicamento foi salvo.",
        variant: "default"
      });
      ...
      toast({
        ...
        description: "Ocorreu um erro ao salvar o lembrete. Tente novamente mais tarde.",
        variant: "destructive"
      });
    } finally {
  ...
  return (
    <div className="p-6">
      <div className="flex items-center mb-6">
        ...
        <h1 className="text-2xl font-bold">Novo Lembrete de Medicamento</h1>
      </div>
                  ...
                  <div key={index} className="flex justify-between items-center p-3 bg-gray-50 rounded-md">
                    <div>
                      ...
                      <p className="text-xs text-gray-500">
                        De {new Date(medicamento.dataInicio).toLocaleString()} até {new Date(medicamento.dataFim).toLocaleString()}
                      </p>
                    </div>
                    <button
                      type="button"
